...
export interface RequestLogger {
  ...
  decorateWithTraceId(req: Request, cb: Function): void;
}
...
export class RequestLoggerImpl implements RequestLogger {
  private asyncLocalStorage: AsyncLocalStorage<Map<string, Logger>>;
  ...
  public decorateWithTraceId(req: Request, cb: Function) {
